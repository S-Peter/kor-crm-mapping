...
ActiveRecord::Schema.define(version: 20150122111536) do
  ...
  create_table "crm_properties", force: true do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  add_index "engagements", ["user_id", "kind", "related_type", "related_id"], name: "lookup", using: :btree
  ...
  add_index "properties", ["label"], name: "index_properties_on_name", using: :btree
  ...
  add_index "ratings", ["entity_id", "state"], name: "index_ratings_on_entity_id_and_state", using: :btree
  add_index "ratings", ["namespace", "user_id", "entity_id"], name: "joint", using: :btree
  ...
  add_index "synonyms", ["entity_id"], name: "index_synonyms_on_entity_id", using: :btree
